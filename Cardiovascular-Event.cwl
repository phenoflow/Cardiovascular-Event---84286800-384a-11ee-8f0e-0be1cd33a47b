...
steps:
  ...
  cardiovascular-event-embolisation---primary:
    run: cardiovascular-event-embolisation---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cardiovascular-event-revision---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cardiovascular-event-embolisation---primary/output
  ...
  vertebrobasilar-cardiovascular-event---primary:
    run: vertebrobasilar-cardiovascular-event---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cardiovascular-event-lacunar---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: vertebrobasilar-cardiovascular-event---primary/output
  ...
  cardiovascular-event-occlusn---primary:
    run: cardiovascular-event-occlusn---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cardiovascular-event-atherosclerosis---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cardiovascular-event-occlusn---primary/output
  ...
  cardiovascular-event-puerperium---primary:
    run: cardiovascular-event-puerperium---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  extradural-cardiovascular-event---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cardiovascular-event-puerperium---primary/output
